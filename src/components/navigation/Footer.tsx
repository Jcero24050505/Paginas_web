      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="mb-4 text-gray-300">For Squash... only Squash</p>
          ...
          <div>
            <h3 className="text-xl font-bold mb-6">{t('nav.quickLinks', 'Quick Links')}</h3>
          ...
          <div>
            <h3 className="text-xl font-bold mb-6">{t('nav.contact', 'Contact')}</h3>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Airport Squash. All rights reserved.
          </p>
